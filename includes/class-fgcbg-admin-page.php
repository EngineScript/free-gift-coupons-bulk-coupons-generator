...
final class FGCBG_Admin_Page {
	...
	public function render(): void {
		?>
		<div class="wrap">
			<h1><?php esc_html_e( 'Free Gift Coupons Bulk Coupon Generator', 'free-gift-bulk-coupon-generator' ); ?></h1>
		...
		<form class="fgcbg-form">
			...
			<p class="submit">
				<button type="submit" class="button-primary">
					<?php esc_html_e( 'Generate Free Gift Coupons', 'free-gift-bulk-coupon-generator' ); ?>
				</button>
			</p>
			...
			<div id="fgcbg-results" class="fgcbg-results" hidden>
				...
				<p>
					<button type="button" id="fgcbg-download-codes" class="button">
						<?php esc_html_e( 'Download .txt', 'free-gift-bulk-coupon-generator' ); ?>
					</button>
				</p>
			</div>
		</form>
	...
	private function render_product_selection_field(): void {
		...
		<tr>
			<th scope="row">
				<label for="fgcbg_product_ids"><?php esc_html_e( 'Select Products', 'free-gift-bulk-coupon-generator' ); ?></label>
			</th>
			<td>
				<select class="wc-product-search fgcbg-product-search" multiple="multiple" id="fgcbg_product_ids" name="product_ids[]"
						data-placeholder="<?php esc_attr_e( 'Search for a product&hellip;', 'free-gift-bulk-coupon-generator' ); ?>"
						data-action="woocommerce_json_search_products_and_variations"
						data-allow_clear="true"
						aria-describedby="product-id-description">
				</select>
				<p class="description" id="product-id-description">
					<?php esc_html_e( 'Search and select one or more products that will be given as free gifts with the coupon.', 'free-gift-bulk-coupon-generator' ); ?>
				</p>
			</td>
		</tr>
		<?php
	...
	private function render_coupon_code_length_field(): void {
		...
		<tr>
			<th scope="row">
				<label for="coupon_code_length"><?php esc_html_e( 'Random Code Length', 'free-gift-bulk-coupon-generator' ); ?></label>
			</th>
			<td>
